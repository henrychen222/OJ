...
// pr(3 * 10 ** 9 >> 0, 3 * 10 ** 9); // wrong
// pr(2 * 10 ** 9 >> 0, 2 * 10 ** 9); // correct  >> not over 2 * 10 ** 9;
// pr(10 ** 10 >> 0, 10 ** 10); // wrong
// pr(768288081 >> 0, 768288081 >> 1, int(768288081 / 2)) // correct

// pr(7682880818 >> 0) // wrong
// pr(76828808182 >> 0) // wrong
// pr(768288081824 >> 0) // wrong

// pr(768288081824 >> 1, 768288081824 / 2) // >> 1 wrong


// pr(1 << 30, 2 ** 30, 1 << 31, 2 ** 31, 10 ** 9) // 1 << highest is 30, 31 is wrong
// pr(3 * 10 ** 9 >> 0, 3 * 10 ** 9); // correct
