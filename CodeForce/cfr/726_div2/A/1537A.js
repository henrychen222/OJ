 ...
 */
// Accepted --- 124ms https://codeforces.com/contest/1537/submission/119918308
const solve = (n, a) => {
    let sum = sm(a);
...
// const solve2 = (n, a) => {
//     let sum = sm(a);
//     let startLen = int(sum / 2);
//     let step = startLen - n;
//     // pr(sum / 2, startLen, step);
//     let t;
//     let len = startLen;
//     for (t = 0; ; t++, len++) {
//         // pr(sum, "len", len, "sum / len", sum / len);
//         if (sum / len == 1 || sum / len == -1) break;
//     }
//     pr(t + step);
// };
...
//     let len = n;
//     let t;
//     // pr(sum, "len", len, "sum / len", sum / len, t);
//     // pr(sum / 2);
//     for (t = 0; ; t++, len++) {
//         pr(sum, "len", len, "sum / len", sum / len);
//         if (sum / len == 1 || sum / len == -1) break;
