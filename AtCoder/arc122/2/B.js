...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * 06/12/21 morning  06/21/21 noon complete
 * https://atcoder.jp/contests/arc122/tasks/arc122_b
 */
// reference: https://atcoder.jp/contests/arc122/submissions/23365677
// Accepted --- https://atcoder.jp/contests/arc122/submissions/23670582 136ms
const solve = (n, a) => {
    stin(a);
    let sum = sm(a);
    let s = 0;
    let min = sum;
    for (let xm = 0; xm < n; xm++) {
        let A = -2 * (n - xm) + n;
        min = mi(min, A * a[xm] / 2 - s + sum);
        s += a[xm];
    }
    pr(min / n);
};
